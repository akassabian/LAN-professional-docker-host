...
module.exports = {
  // Project Identity
  appName: "ajkTheme", // Unique name of your project
  type: "theme", // Plugin or theme
  slug: "ajk", // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
    ...
    // If this has length === 1, then single compiler
    {
      ...
      entry: {
        ...
        //      // global namespace pollutions 😉
         		...
         		mobile: ['./src/app/mobile.js'], // Or an array of string (string[])
      },
